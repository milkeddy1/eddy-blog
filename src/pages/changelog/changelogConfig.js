...
const changelogConfig = [
  ...
  },
  {
    date: '2016年',
    title: '進入虎尾科技大學',
    description: '進入大學，尚未有明確的目標以及興趣，選擇了飛機工程系已較穩定求職為主的選擇。'
  },
  {
    date: '2016 - 2018',
    title: '吉他社生活',
  ...
  },
  {
    date: '2021/2',
    title: '開啟前端工程師之路 !!',
    description: '在畢業之後嘗試了不同類型的工作後，偶然接觸到這個職位，從發現到了解再到嘗試後認為這是我工作心之所向。',
  },
  {
    date: '2021/4 - 2021/7',
    title: '網頁前端工程師實戰班',
    description: '通過線上課程自學一段時間後，決定了這條路，參加了職訓局所開的"網頁前端工程師實戰班"，對於上完課的心得是不認為有能馬上就職的程度，但是確實讓我對這個產業有初步的了解，很有助於後續我自學的方向。'
  },
  {
    date: '2021/6 - 2021/7',
    title: '網頁前端工程師實戰班 - 作品',
  ...
  },
  {
    date: '2021/8 - 2021/12',
    title: '百典創意行銷',
    description: '在該公司主要做的是用wordpress製作、維護網站，主要是在修改CSS排版，操做介面上下架商品，對我來說，比較碰不到什麼程式面的東西，因此選擇在短時間離開。'
  },
  {
    date: '2021/12 - 2022/2',
    title: '開始學習React框架',
    description: '因應許多工作職缺都需要框架，於是硬著頭皮開始學框架，但並沒有真正的去了解為什麼需要用框架的階段。',
  },
  {
    date: '2021/1',
